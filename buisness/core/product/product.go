...
type Core struct {
	// Product core imports user's core this is fair
	// because a Product has a user id "Product is related to a user"
	// We can't do that in user to bring the Product core because
