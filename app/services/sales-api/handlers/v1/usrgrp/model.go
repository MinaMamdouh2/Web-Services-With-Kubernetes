...
// They are exported because we want to use them in tests
// Another opinion make them unexported and in the tests
// we define the types that we need
// Here all types are scaler types, you won't see UIID or email types here
// We are using this due to the shortcoming of the json standard library package
type AppUser struct {
	ID           string   `json:"id"`
